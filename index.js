...
app.use('/api/jquery', express.static(__dirname + '/node_modules/jquery/dist/jquery.min.js'));
app.use('/api/angular', express.static(__dirname + '/node_modules/angular/angular.js'));
app.use('/api/angular-route', express.static(__dirname + '/node_modules/angular-route/angular-route.js'));
app.use('/api/angular-animate', express.static(__dirname + '/node_modules/angular-animate/angular-animate.js'));
